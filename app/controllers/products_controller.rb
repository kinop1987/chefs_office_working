class ProductsController < ApplicationController
  ...
  before_action :check_collect_supplier, except: %i[index new create]
  ...
  def product_collection_params
    params
      .require(:form_product_collection).permit(products_attributes: %i[product_name product_price product_unit availability supplier_id])
  end
